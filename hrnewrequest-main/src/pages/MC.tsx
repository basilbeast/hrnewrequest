      ...
      <>
        ...
        <div className='w-full h-full flex items-center justify-center'>
            <div className='w-[700px] bg-white rounded-xl mt-20 p-5 shadow-xl'>
                <h1 className='text-[32px] font-bold p-5'>New User Account</h1>
                <form className="p-5" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <label className='text-[12px]'>Login Name<br/>
                        <input className='w-full text-[16px] border-solid border-slate-300 border-2 rounded-xl p-2 focus:outline-none' type='textarea' placeholder='Login Name' {...register("loginName")} required/>
                    </label><br/>
                    <label className='text-[12px]'>Email<br/>
                        <input className='w-full text-[16px] border-solid border-slate-300 border-2 rounded-xl p-2 focus:outline-none' type='textarea' placeholder='Email' {...register("email")} required/>
                    </label><br/>
                    <label className='text-[12px]'>Password<br/>
                        <input className='w-full text-[16px] border-solid border-slate-300 border-2 rounded-xl p-2 focus:outline-none' type='textarea' placeholder='Password' {...register("password")} required/>
                    </label><br/>
                    <label className='text-[12px]'>Language<br/>
                        <input className='w-full text-[16px] border-solid border-slate-300 border-2 rounded-xl p-2 focus:outline-none' type='textarea' placeholder='Language' {...register("language")} required/>
                    </label><br/>
                    <label className='text-[12px]'>Department<br/>
                        <input className='w-full text-[16px] border-solid border-slate-300 border-2 rounded-xl p-2 focus:outline-none' type='textarea' placeholder='Department' {...register("department")} required/>
                    </label><br/>
